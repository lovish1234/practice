...
ll noOfOnes(ll n,ll l, ll r)
{
	ll mid=midElementIndex(n);
	ll tot=2*mid-1;

	if(l<mid && r>mid)
	{
		return noOfOnes(n/2,l,mid-1)+(n%2)+noOfOnes(n/2,1,r-mid);
	}
	else if(l<mid && r<mid)
	{
		return noOfOnes(n/2,l,r);
	}
	else if(l>mid && r>mid)
	{
		return noOfOnes(n/2,l-mid,r-mid);
	}
	else if(l<mid && r==mid)
	{
		return noOfOnes(n/2,l,mid-1)+(n%2);
	}
	else if(l==mid && r>mid)
	{
		return noOfOnes(n/2,1,r-mid)+(n%2);
	}
	else if(l==mid && r==mid)
	{
		return (n%2);
